...
class sendingToDB { 
    ...
    async changeStatusInDB(id){
        try {
            ...
            const queryChangeIsDone =" UPDATE list SET isDone=? WHERE id = ?";
            await db.connection.execute(queryChangeIsDone,[!dataFromBack[0].isDone,id]);
